...
% \usepackage{lmodern}   % silence LaTeX Font Warning
...
\footnotetext{\dag%
  In remembrance of our dear friend and colleague, Prof. Tao Yu.
  Deceased 13.06.2021
}
\footnotetext{\ddag%
...
Counting the number of vacancies for a given dose and beam energy allows one to
experimentally determine the sputtering cross section of that crystal.
...
hexagonal boron nitride (hBN) is predicted to be about 80
...
Roqu1992}
% With this amplitude, the interaction between actual material states can be
% written as a linear combination of these free-particle interactions.
...
The experimentally measured band gap of \ce{MoS2} is about 1.9 eV
\cite{Gusakova2017} while that of hBN is about 6.1 eV.\cite{Elias2019}
...
Finally, in the next section, the resulting equation is used
to predict the sputtering rates of boron and nitrogen in hBN and sulfur in
\ce{MoS2}, which can be made to agree well with experiment for appropriate
...
Because we posit that the PKA travels at a constant velocity until it reaches
the sputtering distance $d$, we can write $t_s$ from equation (\ref{eq:R})
quite simply as $t_s = d\sqrt{M/2E}$.
...
There is therefore no reason to expect the predicted lifetimes in this work to
match those obtained by experiments on systems not undergoing sputtering.
...
%------------------------------------------------------------------------------
\subsection{Sulfur sputtering from \texorpdfstring{\ce{MoS2}}{MoS2}}
\label{sec:MoS2}
%------------------------------------------------------------------------------
...
materials as well as layered and confined 2D systems.\cite{Wang2019,
KakanakovaGeorgieva2020, KakanakovaGeorgieva2021, Wang2021}
...
The cutoff energies for hBN and \ce{MoS2} were set to 490 and 408 eV
respectively.
...
Meanwhile, the hBN and \ce{MoS2} unit cells were given heights of 18 and 12
{\AA} respectively.
...
with $\Gamma$-centered $6\times6\times1$ Monkhorst-Pack meshes,
\cite{Monkhorst1976} corresponding to linear k-point spacings of 0.417 and
0.328 {\AA}$^{-1}$ for hBN and \ce{MoS2} respectively.
