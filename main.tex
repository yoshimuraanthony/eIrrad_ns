...
%------------------------------------------------------------------------------
\subsection{Sulfur sputtering from \ce{MoS2}}
\label{sec:MoS2}
%------------------------------------------------------------------------------
...
respectively.
We recognize that these cutoffs are lower than what is typically used
for norm-conserving psuedopotentials.
However, figure \ref{fig:convergences} shows that both cutoffs yield
well-converged values of $S$.
